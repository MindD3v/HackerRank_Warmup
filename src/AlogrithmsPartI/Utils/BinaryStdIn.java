package AlogrithmsPartI.Utils; /*************************************************************************
 *  Compilation:  javac AlogrithmsPartI.BinaryStdIn.java
 *  Execution:    java AlogrithmsPartI.BinaryStdIn < input > output
 *  
 *  Supports reading binary data from standard input.
 *
 *  % java AlogrithmsPartI.BinaryStdIn < input.jpg > output.jpg
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to <tt>AlogrithmsPartI.BinaryStdIn</tt> with calls
   ...
   /**
    ...
    public static void close() {
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("Could not close AlogrithmsPartI.BinaryStdIn");
        }
    }
