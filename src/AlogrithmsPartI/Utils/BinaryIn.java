 ...
 *  Compilation:  javac AlogrithmsPartI.BinaryIn.java
 *  Execution:    java AlogrithmsPartI.BinaryIn input output
 *  
 *  This library is for reading binary data from an input stream.
 *
 *  % java AlogrithmsPartI.BinaryIn http://introcs.cs.princeton.edu/cover.jpg output.jpg
 *
 *************************************************************************/
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to <tt>AlogrithmsPartI.BinaryIn</tt> with calls
